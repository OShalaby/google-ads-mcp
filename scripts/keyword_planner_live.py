...
def main() -> None:
    ...
    # --- Build request ---
    kw_service = client.get_service("KeywordPlanIdeaService", version="v22")

    request = client.get_type("GenerateKeywordIdeasRequest", version="v22")
    request.customer_id = customer_id
    request.language = "languageConstants/1000"  # English
    request.geo_target_constants.append("geoTargetConstants/2840")  # US
    request.page_size = 5

    keyword_seed = client.get_type("KeywordSeed", version="v22")
