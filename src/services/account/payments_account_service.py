...
from google.ads.googleads.v22.services.services.payments_account_service import (
    PaymentsAccountServiceClient,
)
from google.ads.googleads.v22.services.types.payments_account_service import (
