...
from google.ads.googleads.v22.services.services.audience_service import (
...
class AudienceService:
    ...
    def _create_audience_dimension(self, config: Dict[str, Any]) -> AudienceDimension:
        ...
        if dimension_type == "AGE":
            ...
            for age_range in age_ranges:
                ...
                from google.ads.googleads.v22.common.types.audiences import AgeSegment
            ...
            from google.ads.googleads.v22.enums.types.income_range_type import (
                IncomeRangeTypeEnum,
            )
            ...
            from google.ads.googleads.v22.common.types.audiences import AudienceSegment
    ...
    def _create_audience_exclusion_dimension(
        ...
        if dimension_type == "USER_LIST":
            from google.ads.googleads.v22.common.types.audiences import ExclusionSegment
