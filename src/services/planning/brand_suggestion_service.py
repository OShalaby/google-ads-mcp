...
from google.ads.googleads.v22.services.services.brand_suggestion_service import (
    BrandSuggestionServiceClient,
)
from google.ads.googleads.v22.services.types.brand_suggestion_service import (
